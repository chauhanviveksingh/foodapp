    ...
    <div className="section-container bg-gradient-to-r from-white via-white to-indigo-500">
      <div className="py-24 flex flex-col md:flex-row justify-between items-center gap-8 ">
        ...
        <div className="md:w-1/2">
          <img src="https://media.gettyimages.com/id/1377926786/photo/teenage-girl-having-breakfast.jpg?s=612x612&w=0&k=20&c=1A8qPEUmQH4Tsgbav1jOK4IYX74T_5mkyvfplB0lATc=" alt="" className="rounded-full " />

          <div className="flex flex-col md:flex-row items-center justify-around -mt-14 gap-4">
            <div className="sm:flex hidden  bg-white py-2 px-3 rounded-2xl items-center gap-4 shadow-md w-20">
              <img
                src="https://pluspng.com/img-png/ice-cream-png-ice-cream-png-transparent-image-1574.png"
                alt=""
            ...
            <div className="sm:flex hidden bg-white py-2 px-3 rounded-2xl items-center gap-4 shadow-md w-20">
              <img
                src="https://pluspng.com/img-png/sandwich-png-hd-sandwich-png-image-sandwich-hd-png-2594.png"
                alt=""
                className="rounded-2xl"
              />
