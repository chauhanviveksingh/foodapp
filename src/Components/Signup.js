...
const Signup = () => {
    ...
    return (
        <div className="max-w-md bg-white w-full mx-auto text-center justify-center my-20 rounded-2xl">
        ...
        <h1 className="font-bold text-lg text-center">Create A account</h1>
          ...
          <p className="text-center my-2">
            Already have an account?
              <button className="underline text-red ml-2" onClick={()=>document.getElementById("my_modal_5").showModal()}
                >
                   Login!
                 </button>{" "}
              </p>
